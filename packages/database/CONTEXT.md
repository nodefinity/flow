...
The local track catalogue and data access layer. Owns the SQLite schema (via Drizzle), migrations, and query functions. Responsible for storing Track and TrackMetadata, scanning the device file system, and answering CandidateSet queries from the Radio context.
