/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: ef3ae6f8355c5d32e5a96d11960d0345)
// Runtime types generated with workerd@1.20260623.1 2026-06-25 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "http://localhost:4321,http://localhost:8787,https://flow-dcx.pages.dev";
}
