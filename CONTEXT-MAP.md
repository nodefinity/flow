...
- [Website](./apps/www/CONTEXT.md) — public marketing, download, legal, and launch-readiness pages
- [API](./apps/api/CONTEXT.md) — public Worker endpoints for launch and marketing operations
